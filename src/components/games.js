...
export default function Games(){
    return(
        <div className="bg-gray-200 w-10/12 md:w-11/12" >
        <h1 className="my-5 text-2xl md:text-5xl text-purple-400"><strong>OUR BEST GAMES</strong></h1>
            ...
            <div>
                <div className="flex flex-col">
                    <div className="flex flex-col lg:flex-row mb-4">
                        <div className="flex flex-col lg:mr-2 md:flex-row md:h-48 mb-5 lg:mb-0">
                        ...
                        <div className="flex flex-col md:flex-row md:h-48 mb-5 lg:mb-0">
                    ...
                    <div className="text-left md:w-8/12">
                        ...
                        <p className="md:text-lg">Get new Friends in Call of Duty Mobile and get a lot rewards! Swap your Call of Duty Mobile invitation code here. All the intensity of Call of Duty at your fingertips. Travel through the iconic maps of the Call of Duty...</p>
                    </div></div>
